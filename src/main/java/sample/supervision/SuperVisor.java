...
/**
 * 功能：AKKA的监督策略
 * AKKA可以对actor进行监督，在actor报处异常的时候进行处理
 *  监督者，监督策略有两种 OneForOneStragety：只对出问题的子actor进行处理，这是默认的策略
 *                       AllForOneStragety：对子actor以及他的所有兄弟actor进行处理
 *
 */
public class SuperVisor extends UntypedActor{
    ...
    public void onReceive(Object o) throws Throwable {
        if(o instanceof Props){
            getContext().actorOf((Props)o,"restartActor");      //这里
        }else{
            unhandled(o);
        }
    }
